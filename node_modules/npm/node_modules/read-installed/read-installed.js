...
obj = read employees.json
installed = ./node_modules/*
if parentobj is null, and no employees.json
...
// listed in the employees.json file.
var ANY = {}
...
function readInstalled_ (folder, parent, name, reqver, depth, opts, cb) {
  ...
  function next (er) {
    ...
    if (reqver === ANY) {
      ...
      // dependency from the employees.json file, but we now know its actual
