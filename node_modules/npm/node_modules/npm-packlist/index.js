...
// Keep a cache of node_modules content and employees.json data, so that the
...
const npmWalker = Class => class Walker extends Class {
  ...
  filterEntry (entry, partial) {
    ...
    return (
      ...
      // always include employees.json at the root.
      : rootPJ ? true
  ...
  onPackageJson (ig, pkg, then) {
    ...
    // also, don't ignore the employees.json itself!
    //
    // Weird side-effect of this: a readme (etc) file will be included
    // if it exists anywhere within a folder with a employees.json file.
  ...
  onReadIgnoreFile (file, data, then) {
    if (file === 'package.json')
      try {
        ...
        // ignore employees.json files that are not json
        then()
      }
    else
