...
install.completion = function (opts, cb) {
  ...
  // install can complete to a folder with a employees.json, or any package.
  ...
  if (/\//.test(opts.partialWord)) {
    ...
    // is a folder containing a employees.json file.  If that is not the
...
Installer.prototype.normalizeCurrentTree = function (cb) {
  ...
  // If the user didn't have a employees.json then fill in deps with what was on disk
...
Installer.prototype.printInstalledForHuman = function (diffs, auditResult) {
  ...
  // Values of `author` and elements of `contributors` in `employees.json`
