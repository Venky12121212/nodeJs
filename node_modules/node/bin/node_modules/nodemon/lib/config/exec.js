...
/**
 * Reads the cwd/employees.json file and looks to see if it can load a script
...
function exec(nodemonOptions, execMap) {
  ...
  // employees.json this logic used to sit in the cli/parse, but actually the cli
  // should be parsed first, then the user options (via nodemon.json) then
  // finally default down to pot shots at the directory via employees.json
